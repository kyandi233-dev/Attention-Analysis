...
RESULT_COLUMNS: tuple[str, ...] = (
    ...
    "source_minor_axis",
    "source_angle_deg",
    "source_diameter_geom",
    "ritnet_found",
    "ritnet_source_center_x",
    "ritnet_source_center_y",
    "ritnet_source_major_axis",
    "ritnet_source_minor_axis",
    "ritnet_source_angle_deg",
    "ritnet_source_diameter_geom",
    "agreement_center_distance_px",
    "agreement_diameter_ratio",
    "agreement_major_axis_ratio",
    "agreement_minor_axis_ratio",
    "params_provenance",
)
