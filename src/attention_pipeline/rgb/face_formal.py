...
def run_face_formal_prepare(config: Config, subject: str) -> dict[str, object]:
    """Build the full formal timestamp-driven Face sample grid without extracting JPEGs."""
    ...
    summary = {
        ...
        "notes": [
            ...
            "No JPEG extraction: the formal CUDA runner decodes selected positions directly from the original AVI.",
