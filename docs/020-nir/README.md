...
**44 人 cohort 分析计划与进度：** [028-2026-08-26-NIR-cohort44分析实施计划与进度.md](028-2026-08-26-NIR-cohort44分析实施计划与进度.md)。当前 44 人作为 exploratory/development cohort（探索/开发样本），按 Phase 1 QC → Phase 2 左右眼/标准化 → Phase 3 time-on-task → Phase 4 Behavior/Probe → Phase 5 robustness/ML 推进；最终北京样本仍为 116 人。

> 下方 08-13、08-16、08-17、08-21、08-22 内容按当时研究阶段保留。其中“候选 / 待实测 / 停止门 / 尚未全量”等措辞是历史状态，不代表当前状态。历史资料使用日期型文件名，不再占用其他模块的核心编号。
...
| [027-44人全量分析数据边界与资料清单.md](027-44人全量分析数据边界与资料清单.md) | 44 人 full-class / Behavior / questionnaire 等本地资料边界与清单 | **当前 cohort 数据边界** |
| [028-2026-08-26-NIR-cohort44分析实施计划与进度.md](028-2026-08-26-NIR-cohort44分析实施计划与进度.md) | 44 人开发样本的 Phase 1–5 科学路线、输出结构、冻结/未冻结项与已验收进度 | **当前 cohort 分析总计划** |
...
| [08-13 历史审计计划](08-13-01-NIR现状审计与分阶段实施计划.md) | 最早只读审计快照；已恢复为日期型历史文件名，避免与 overview `011` 混淆 |
