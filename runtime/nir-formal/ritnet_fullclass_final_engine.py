...
batch N+1 overlaps CUDA inference of batch N, while CPU metric reduction of
...
def _report_progress(
    *,
    ...
    gpu_ms = timing_total.get("gpu_and_transfer_ms", 0.0)
    ...
    print(
        ...
        f"stage_ms(prod={producer_ms:.0f},gpu={gpu_ms:.0f},summary={summary_ms:.0f})",
        flush=True,
    )
