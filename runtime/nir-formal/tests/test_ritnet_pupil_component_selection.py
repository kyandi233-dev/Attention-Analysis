...
def _fragmented_labels() -> np.ndarray:
    ...
    # Main anatomical iris+pupil structure.
    cv2.ellipse(labels, (260, 190), (105, 62), 0, 0, 360, 2, -1)
    cv2.ellipse(labels, (260, 190), (18, 14), 0, 0, 360, 3, -1)

    # Peripheral false-positive island. Its pupil component is deliberately
    # larger than the true pupil, reproducing the failure mode where historical
    # largest-pupil-contour selection jumps outside the main iris.
