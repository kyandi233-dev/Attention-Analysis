...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run native Py-Feat Detectorv2 CPU reference on formal RGB Face sample")
    parser.add_argument("--sample-dir", required=True)
    parser.add_argument("--output-dir", required=True)
    parser.add_argument("--batch-size", type=int, default=8)
    parser.add_argument("--num-workers", type=int, default=0)
    parser.add_argument("--max-frames", type=int, default=None, help="Diagnostic prefix only; omit for the full sample")
