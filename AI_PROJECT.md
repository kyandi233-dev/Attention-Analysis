...
- project_identity: FocusWave Behavior / NIR / RGB producer and single-modality analysis
- canonical_repository: https://github.com/kyandi233-dev/Attention-Analysis.git
- canonical_branch: repository default currently `codex/formal-analysis-v2-portable`; task-specific producer work may explicitly select another maintained branch/ref
- repository_role: behavior, NIR and RGB producer/runtime engineering, merge-ready outputs and single-modality analysis; not the owner of final central multimodal inference
